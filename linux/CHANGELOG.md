...
- The built-in SSH client can authenticate with keys held by ssh-agent, chosen as "SSH agent" in the SSH section; a missing agent or an agent with no keys is reported plainly.
